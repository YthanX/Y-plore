...
#define GPIOX_MODE_(a,b,c)    ((GPIO_TypeDef*)((((uint32_t)(c) & 8u) >> 1) + GPIO ## b ## _BASE))->CRL = (((GPIO_TypeDef*)((((uint32_t)(c) & 8u) >> 1) + GPIO ## b ## _BASE))->CRL & ~(0xFu << ((((uint32_t)(c) & 7u) << 2)))) | (((uint32_t)(a) & 0xFu) << ((((uint32_t)(c) & 7u) << 2)))
